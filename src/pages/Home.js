...
function home1(){
    return(
        ...
        <div class="carousel-inner">
            ...
            <img class="d-block w-100 img-fluid" style={{height:550}} src={Image1} alt="First slide"/>
            </div>
            <div class="carousel-item">
            <img class="d-block w-100 img-fluid" style={{height:550}} src={Image2} alt="Second slide"/>
            </div>
            <div class="carousel-item">
            <img class="d-block w-100 img-fluid" style={{height:550}} src={Image3} alt="Third slide"/>
            </div>
        </div>
